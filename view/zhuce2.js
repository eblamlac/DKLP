...
import { Text, TouchableHighlight, TextInput, Image, Dimensions, TouchableOpacity, View, StatusBar, TouchableNativeFeedback } from 'react-native'
...
export default class zhuce1 extends Component {
    test() {
        ...
        fetch('http://clayawky.com/user/yzm', {
          ...
          body: 'yzm=' + yzm1+ '&email=' + this.props.route.params.QQemail+"@qq.com"
        }).then((res) =>console.log(res.json)
        )
    }
    componentDidMount(){
        console.log("nani ???????")
        this.setState({ yzm:this.props.route.params.yzm})
    ...
    render() {
        ...
        return (
            ...
            >
                ...
                onPress={()=>{
                var a=this._nani().toUpperCase().trim()
                console.log(a)
                this.refs.A2.focus()
                 this.refs[a].focus()
            }}
                    ...
                    <View
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => {
                                ...
                                if (text != '') {
                                    if(`${this.state.a1}${this.state.a2}${this.state.a3}${this.state.a4}${this.state.a5}${text}`===this.state.yzm){
                                        this.props.navigation.navigate('zhuce3', {
                                            QQemail: this.props.route.params.QQemail
                                          })
                                    }else{
                                      console.log(`${this.state.a1}${this.state.a2}${this.state.a3}${this.state.a4}${this.state.a5}${text}`)
                                
                                       console.log(route.params.yzm+"aaa")
                                        alert('失败')
                                    }
                                } else {
                                    this.refs.A6.focus()
